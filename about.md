...
有很多事情能使我免除焦虑，在绿道上 `漫步` 一整天而不嫌累，在 `球场` 上奔跑扮演曼彻斯特的 `德布劳内`，坐在公交车上听着 `王菲` 的天空，雨天点起小灯敲一敲 `代码`，虽然到了晚上还是不一定睡得着。
...
<a href="https://www.elastic.co/cn/elasticsearch" target="_blank"> <img alt="rabbitmq" src="https://api.iconify.design/skill-icons/rabbitmq-dark.svg?height=36"> </a>  
...
搭建这个知识笔记网站，是为了我给平日做的笔记做里程碑式的回顾与总结，还方便我随时随地检索知识库或跳转官方文档，而无需打开编辑器。

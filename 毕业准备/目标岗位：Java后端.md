...
![image-20211103022819150](目标岗位：Java后端/image-20211103022819150.png)

![12cdecb053cade438802732e3f6bd4ce.png](目标岗位：Java后端/12cdecb053cade438802732e3f6bd4ce-16370310097172.png)
...
![image-20220422143950938](目标岗位：Java后端/image-20220422143950938.png)
...
* cookie + redis实现
  ...
  ![image-20220402111735827](目标岗位：Java后端/image-20220402111735827.png)

* 使用token实现

  ![image-20220402112451274](目标岗位：Java后端/image-20220402112451274.png)
...
![image-20220303134116555](目标岗位：Java后端/image-20220303134116555.png)
...
![image-20220304015415682](目标岗位：Java后端/image-20220304015415682.png)
...
![image-20220304030037260](目标岗位：Java后端/image-20220304030037260.png)
...
![img](目标岗位：Java后端/478153-20190114095833124-78893018.png)
...
2. 使用 Refresh Token，它可以避免频繁的读写操作。这种方案中，当客户端发送业务请求时，服务端不需要刷新 Token 的过期时间，一旦 Token 过期，就反馈给前端，前端转而使用 Refresh Token 申请一个全新 Token 继续使用。这种方案中，服务端只需要在客户端请求更新 Token 的时候对 Refresh Token 的有效性进行一次检查，大大减少了更新有效期的操作，也就避免了频繁读写。
   ...
   ![img](目标岗位：Java后端/image_000145-16370547411232.jpg)
...
![image-20211106174908962](目标岗位：Java后端/image-20211106174908962.png)

目标

![img](目标岗位：Java后端/1418466-20180920101834786-70451080.png)

...
![img](assets/103049o4u9udq29zbhh9tg-171396769407725.png)

2、浏览器中输入纽曼随身WIFI的管理IP：http://192.168.0.1/，输入密码admin登陆管理后台。

![img](assets/103049rv7bru0rv1rble00-171396769407727.png)

3、点击高级设置--其他--SIM卡选择--启动卡--外插卡--应用--SIM卡解锁--输入解锁码：az952#

![img](assets/103050cpnna8iaaava9auu-171396769407729.png) ![img](assets/103050sfm9swfu99i9czf9-171396769407731.png)
...
![img](assets/103051pftbp7nil472ulbl-171396769407733.png)

![img](assets/103051bv9tz48v7651x48x-171396769407735.png)

4、根据提示完成ADB开启

5、选择中兴微入口

![img](assets/103053dx6qqgk0rv5qkq0v-171396769407837.png)

6、选择中兴微去后门

![img](assets/103053szzq4ufff3f5895b-171396769407839.png)

![img](assets/103752b6m5m5502o908ujm-171396769407841.png)

7、成功后会有大功告成的提示

![img](assets/103053nsnopjyyi22p2ees-171396769407843.png)

二、改串号

1、打开高级设置--其他，按键盘F12打开控制台，输入：$("*").show()

![img](assets/103054x75l2bl25j41c4ox-171396769407845.png)
...
![image-20240615173803998](assets/image-20240615173803998.png)

![img](assets/103054yjg3c4mjca5gmgxs-171396769407847.png)
...
![img](assets/v2-b4cdbf677b0b0e9407a42fe053aebf2a_720w.webp)
...
![img](assets/v2-5fc69ed4a11a0168f34689e0a5a50c59_720w.webp)
...
![img](assets/v2-30c6a7c075a9a97831c7e3368e4fdff6_720w.webp)
...
![img](assets/v2-d713388f8c5e264f0bb9c009ce0d8778_720w.png)

![img](assets/v2-aff8b46277ede290ccf10a4c4dc39558_720w.webp)

命令执行完成后，断掉路由器电源，按住reset键，插上电源，等到路由器闪烁时，松开reset键，访问192.168.1.1，可以成功进入breed页面

![img](assets/v2-e8d6d6310f577dc971a584fcb37d5f52_720w.webp)
...
![img](assets/v2-687059fd15ea720efb8ec9d9b4bbfb60_720w.webp)

\2. 在breed中，选择固件更新

> 先选择闪存布局为`小米R3G OpenWrt`，在分别选择上一步现在的前两个文件，记得勾选**自动重启**

![img](assets/v2-43d4ffa0574936c42d2abed50712b4c0_720w.webp)

\3. 点击上传，点击更新

> 输入成功后，如果你上一步勾选了自动重启，现在你就可以访问`192.168.15.1`打开路由器后台了，如果没有勾选，请等待更新完成后手动断掉路由器电源重启。

![img](assets/v2-cc0629745bdf19d150b68c21d3b719ae_720w.webp)

\4. 进行固件更新

> 访问`192.168.15.1`进入路由后台，账号密码都是admin。导航栏——>系统——>备份与升级

![img](assets/v2-8f5a5e6e43439fbbf2415ce237d8e9b8_720w.webp)

> 在“刷写新的固件”中，点击`刷写固件`，选择刚才下的固件，上传，结束后，重启

![img](assets/v2-8a7ce4fc9e4d5f325f08b4c27cc46641_720w.webp)

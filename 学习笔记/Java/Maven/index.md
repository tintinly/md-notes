...
1. 编辑 pom.xml，光标选择进 `<dependencies>` 元素中

2. <kbd> alt </kbd> + <kbd> insert </kbd> 或者右键选择 `Generate`

   ![image-20260611223507664](assets/image-20260611223507664.png)

3. 选择 Dependency 或 Managed Dependency 搜索并插入想要的依赖
...
[maven 配置 settings.xml 配置详解 - hanease - 博客园](https://www.cnblogs.com/hanease/p/19216401)

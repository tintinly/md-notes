...
![image-20220319144731338](Nginx/image-20220319144731338.png)
...
![image-20220319144744283](Nginx/image-20220319144744283.png)
...
![image-20220319145049979](Nginx/image-20220319145049979.png)

## 1.6 动静分离

为了加快网站的解析速度，可以把动态页面和静态页面由不同的服务器来解析，加快解析速 度。降低原来单个服务器的压力

![image-20220319145123757](Nginx/image-20220319145123757.png)

# 2 nginx安装

[nginx news](http://nginx.org/)

![image-20220319150343861](Nginx/image-20220319150343861.png)
...
![image-20220319152253966](Nginx/image-20220319152253966.png)
...
![image-20220319205614119](Nginx/image-20220319205614119.png)

![image-20220319205359261](Nginx/image-20220319205359261.png)

配置

![image-20220319212852932](Nginx/image-20220319212852932.png)
...
![image-20220319215527129](Nginx/image-20220319215527129.png)
...
![image-20220319220708096](Nginx/image-20220319220708096.png)

![image-20220319220738216](Nginx/image-20220319220738216.png)
...
![image-20220319221323382](Nginx/image-20220319221323382.png)

3、ip_hash 每个请求按访问 ip 的 hash 结果分配，这样每个访客固定访问一个后端服务器，可以解决 session 的问题。 例如：

![image-20220319221340437](Nginx/image-20220319221340437.png)

4、fair（第三方） 按后端服务器的响应时间来分配请求，响应时间短的优先分配。

![image-20220319221418637](Nginx/image-20220319221418637.png)
...
![image-20220320003455531](Nginx/image-20220320003455531.png)

进行 nginx 配置

![image-20220320003517077](Nginx/image-20220320003517077.png)

autoindex 可以列出文件名

![image-20220320003544737](Nginx/image-20220320003544737.png)
...
![image-20220320101721041](Nginx/image-20220320101721041.png)

两台服务器

![image-20220320110448356](Nginx/image-20220320110448356.png)

![image-20220320110415699](Nginx/image-20220320110415699.png)	
...
![image-20220320120924597](Nginx/image-20220320120924597.png)

![image-20220320120812138](Nginx/image-20220320120812138.png)

![image-20220320121012839](Nginx/image-20220320121012839.png)

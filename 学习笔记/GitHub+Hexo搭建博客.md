...
![image-20211026215705482](GitHub+Hexo搭建博客/image-20211026215705482.png)

# 2 Git安装

进入Git官网[Git (git-scm.com)](https://git-scm.com/)，点击 ***Downloads*** 下载并安装

![image-20211026215844662](GitHub+Hexo搭建博客/image-20211026215844662.png)

打开 Git Bash, 输入git 回车得到如下图 即完成

![image-20211026215909809](GitHub+Hexo搭建博客/image-20211026215909809.png)
...
![image-20211026220528938](GitHub+Hexo搭建博客/image-20211026220528938.png)

生成密钥。输入 ssh-keygen -t rsa 命令***（注意空格）*** 敲四次回车键，之后就就会生成两个文件，分别为秘钥 id_rsa.txt 和公钥 id_rsa.pub。

![image-20211026220813812](GitHub+Hexo搭建博客/image-20211026220813812.png)
...
![image-20211026221429113](GitHub+Hexo搭建博客/image-20211026221429113.png)

如下图，先点击 ***SSH and GPG keys，\***再点击 ***New SSH key.***

将复制的公钥 id_rsa.pub 的内容粘贴到 key 内，再点击 ***Add SSH key，\***如下图：

![image-20211026221447130](GitHub+Hexo搭建博客/image-20211026221447130.png)

验证是否成功，我们可以通过在 Git Bash 中输入 ` ssh -T git@github.com` 进行检验：

![image-20211026221706966](GitHub+Hexo搭建博客/image-20211026221706966.png)

第一次会出现这种情况，填 yes 就行，若出现下图中的情况，则表明绑定成功：

![image-20211026221652971](GitHub+Hexo搭建博客/image-20211026221652971.png)
...
![image-20211026222959396](GitHub+Hexo搭建博客/image-20211026222959396.png)
...
![image-20211026223115440](GitHub+Hexo搭建博客/image-20211026223115440.png)
...
![image-20211026223604700](GitHub+Hexo搭建博客/image-20211026223604700.png)

### 上传文件

创建一个 text.txt 测试文件![image-20211026224007291](GitHub+Hexo搭建博客/image-20211026224007291.png)
...
![image-20211026224100848](GitHub+Hexo搭建博客/image-20211026224100848.png)
...
![image-20211026224324642](GitHub+Hexo搭建博客/image-20211026224324642.png)
...
![image-20211026224458508](GitHub+Hexo搭建博客/image-20211026224458508.png)

再输入 git status 查看一下仓库状态：

![image-20211026224534281](GitHub+Hexo搭建博客/image-20211026224534281.png)
...
![image-20211026225244794](GitHub+Hexo搭建博客/image-20211026225244794.png)

刷新 GitHub 中 text 仓库：

![image-20211026225304010](GitHub+Hexo搭建博客/image-20211026225304010.png)
...
![image-20211026230820027](GitHub+Hexo搭建博客/image-20211026230820027.png)
...
![image-20211027004134866](GitHub+Hexo搭建博客/image-20211027004134866.png)
...
![image-20211027011802699](GitHub+Hexo搭建博客/image-20211027011802699.png)
...
![image-20211027011909113](GitHub+Hexo搭建博客/image-20211027011909113.png)

然后输入 hexo g 静态部署：

![image-20211027011927526](GitHub+Hexo搭建博客/image-20211027011927526.png)
...
![image-20211027012112994](GitHub+Hexo搭建博客/image-20211027012112994.png)

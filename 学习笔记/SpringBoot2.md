...
![img](SpringBoot2/1608732849545-c9ff8b56-4f77-42a1-bc02-252b80896440.png)

![img](SpringBoot2/1608732931315-80c3c33c-5d72-4924-b771-4c9f5834071a.png)
...
![img](SpringBoot2/1602641710418-5123a24a-60df-4e26-8c23-1d93b8d998d9.png)
...
![img](SpringBoot2/1602642309979-eac6fe50-dc84-49cc-8ab9-e45b13b90121.png)
...
* SprinBoot + SpringCloud+SpringCloud Data Flow
  ...
  ![img](SpringBoot2/1599799119457-841ef47a-6585-4ca4-8e3d-8298e796012c-16411811881992.png)
...
![image-20220103143157533](SpringBoot2/image-20220103143157533.png)

把项目打成jar包，直接在目标服务器执行即可。

> 取消掉cmd的快速编辑模式

![image-20220103143403089](SpringBoot2/image-20220103143403089.png)
...
![image-20220103151209598](SpringBoot2/image-20220103151209598.png)
...
* 按需加载所有自动配置项
  ...
  * SpringBoot所有的自动配置功能都在 spring-boot-autoconfigure 包里面
  ...
  ![image-20220103153216147](SpringBoot2/image-20220103153216147.png)
...
![image-20220103171957380](SpringBoot2/image-20220103171957380.png)
...
![image-20220104150836242](SpringBoot2/image-20220104150836242.png)
...
* 查看自动配置是否生效
  ...
  * 开启debug模式 debug=true 获取自动配置报告CONDITIONS EVALUATION REPORT
    ...
    ![image-20220104151303869](SpringBoot2/image-20220104151303869.png)
...
2. 热更新、热部署无需重新启动（Reload）
   ...
   ![image-20220104154351523](SpringBoot2/image-20220104154351523.png)
...
3. 自动创建项目结构
   ...
   ![image-20220104155413833](SpringBoot2/image-20220104155413833.png)
...
![image-20220105003730867](SpringBoot2/image-20220105003730867.png)
...
![image.png](SpringBoot2/1603181171918-b8acfb93-4914-4208-9943-b37610e93864.png)
...
![image-20220106011942736](SpringBoot2/image-20220106011942736.png)

其中，RequestMappingHandlerMapping：保存了所有@RequestMapping 和handler的映射规则。如下

![image-20220106012624867](SpringBoot2/image-20220106012624867.png)

![image-20220106043830791](SpringBoot2/image-20220106043830791.png)
...
![image.png](SpringBoot2/1603271442869-63b4c3c7-c721-4074-987d-cbe5999273ae.png)

![image.png](SpringBoot2/1603271678813-d8e1a1e5-94fa-412c-a7f1-6f27174fd127.png)

![image-20220106210201731](SpringBoot2/image-20220106210201731.png)
...
![image-20220106150024529](SpringBoot2/image-20220106150024529.png)
...
![image-20220106155100202](SpringBoot2/image-20220106155100202.png)

![image.png](SpringBoot2/1603263394724-33122714-9d06-42ec-bf45-e440e8b49c05.png)
...
![image-20220106155433445](SpringBoot2/image-20220106155433445.png)
...
![image-20220109115554689](SpringBoot2/image-20220109115554689.png)
...
![image-20220106210806015](SpringBoot2/image-20220106210806015.png)
...
![image-20220115141020504](SpringBoot2/image-20220115141020504.png)
...
![image-20220110143350023](SpringBoot2/image-20220110143350023.png)
...
![image.png](SpringBoot2/1605151728659-68c8ce8a-1b2b-4ab0-b86d-c3a875184672.png)
...
3. RequestResponseBodyMethodProcessor 可以处理返回值标了@ResponseBody 注解的。
   1. 利用 MessageConverters 进行处理 将数据写为json
      ...
      1. 内容协商（浏览器默认会以请求头的方式告诉服务器他能接受什么样的内容类型）
         ...
         ![image-20220115144224717](SpringBoot2/image-20220115144224717.png)
...
![image-20220115145539416](SpringBoot2/image-20220115145539416.png)
...
![image-20220115150737222](SpringBoot2/image-20220115150737222.png)
...
![image-20220115152630637](SpringBoot2/image-20220115152630637.png)
...
![image-20220117152539051](SpringBoot2/image-20220117152539051.png)
...
1. Parameter策略优先确定是要返回json数据（获取请求头中的format的值）
   ...
   ![image-20220117153450709](SpringBoot2/image-20220117153450709.png)
...
2. 获取客户端（PostMan、浏览器）支持接收的内容类型。（获取客户端Accept请求头字段）【application/xml】
   ...
   * **contentNegotiationManager** **内容协商管理器 默认使用基于请求头的策略**（可以添加、修改策略）
     ...
     ![image.png](SpringBoot2/1605230462280-ef98de47-6717-4e27-b4ec-3eb0690b55d0.png)

   * **HeaderContentNegotiationStrategy  确定客户端可以接收的内容类型** 

     ![image.png](SpringBoot2/1605230546376-65dcf657-7653-4a58-837a-f5657778201a.png)

     ![image-20220117142054431](SpringBoot2/image-20220117142054431.png)
...
![image-20220117141133171](SpringBoot2/image-20220117141133171.png)
...
​	![image-20220117142622205](SpringBoot2/image-20220117142622205.png)
...
![image-20220117171305048](SpringBoot2/image-20220117171305048.png)
...
![image-20220117174221722](SpringBoot2/image-20220117174221722.png)

![image-20220117173746753](SpringBoot2/image-20220117173746753.png)

## 5.5 视图解析与模板引擎

### 5.5.1 视图解析

![image-20220119151547728](SpringBoot2/image-20220119151547728.png)
   ...
   1. render(mv, request, response); 进行页面渲染逻辑
      ...
      1. 根据方法的String返回值得到 View 对象【定义了页面的渲染逻辑】
         ...
         1. 所有的视图解析器(5个)尝试是否能根据当前返回值得到View对象
            ...
            ![image-20220119153219752](SpringBoot2/image-20220119153219752.png)

         2. 得到了  redirect:/main.html --> Thymeleaf new RedirectView()

         3. ContentNegotiationViewResolver 里面包含了下面所有的视图解析器，内部还是利用下面所有视图解析器得到视图对象。

            ![image-20220119155257404](SpringBoot2/image-20220119155257404.png)
         ...
         4. 得到视图对象后 view.render(mv.getModelInternal(), request, response);   视图对象调用自定义的render进行页面渲染工作
            ...
            ![image-20220119155720003](SpringBoot2/image-20220119155720003.png)
...
![image-20220118144656013](SpringBoot2/image-20220118144656013.png)
...
![image-20220122121617249](SpringBoot2/image-20220122121617249.png)

### 5.6.3 拦截器原理

1. 根据的请求到能处理当前请求的HandlerExecutionChain内含拦截器链

![image-20220122124227726](SpringBoot2/image-20220122124227726.png)
...
![img](SpringBoot2/1605765121071-64cfc649-4892-49a3-ac08-88b52fb4286f-16428320390122.png)
...
* 对于机器客户端，它将生成JSON响应，其中包含错误，HTTP状态和异常消息的详细信息。对于浏览器客户端，响应一个“ whitelabel”错误视图，以HTML格式呈现相同的数据![image-20220122183955029](SpringBoot2/image-20220122183955029.png)
...
* error/下的4xx，5xx页面会被自动解析；
  ...
  ![image-20220122184752650](SpringBoot2/image-20220122184752650.png)
...
3. mv = processHandlerException；处理handler发生的异常，处理完成返回ModelAndView；
   ...
   2. 系统默认的异常解析器
      ...
      ![image-20220124140858468](SpringBoot2/image-20220124140858468.png)
...
4. 如果没有任何人能处理最终底层就会发送 /error 请求。会被底层的BasicErrorController处理
   ...
   ![image-20220124143356744](SpringBoot2/image-20220124143356744.png)
   ...
   1. 解析错误视图；遍历所有的  ErrorViewResolver  看谁能解析。
      ...
      ![image-20220124144157511](SpringBoot2/image-20220124144157511.png)
...
![image-20220125131454274](SpringBoot2/image-20220125131454274.png)
...
* 切换服务器
  ...
  ![image.png](SpringBoot2/1606280937533-504d0889-b893-4a01-af68-2fc31ffce9fc.png)
...
![image-20220126025956042](SpringBoot2/image-20220126025956042.png)
...
![image-20220126220349100](SpringBoot2/image-20220126220349100.png)
...
![image-20220127015738877](SpringBoot2/image-20220127015738877.png)
...
![image-20220127051400439](SpringBoot2/image-20220127051400439.png)
...
![image-20220128023721072](SpringBoot2/image-20220128023721072.png)
...
![image-20220129145258194](SpringBoot2/image-20220129145258194.png)
...
![img](SpringBoot2/1606796395719-eb57ab48-ae44-45e5-8d2e-c4d507aff49a.png)
...
![image-20220130025006223](SpringBoot2/image-20220130025006223.png)
...
![image-20220130213539979](SpringBoot2/image-20220130213539979.png)

### 8.1.2 版本变化

![image.png](SpringBoot2/1606884394162-ac7f2d8e-7abb-44df-9998-fb0f2705f238.png)
...
* 指定环境配置文件  application-{env}.yaml
  ...
  ![image-20220207143135737](SpringBoot2/image-20220207143135737.png)
...
![image-20220207160230628](SpringBoot2/image-20220207160230628.png)
...
1. 创建 SpringApplication
   ...
   * 找 ApplicationListener  ；应用监听器。去spring.factories找 ApplicationListener
   ...
   ![image-20220207195219049](SpringBoot2/image-20220207195219049.png)
...
![image.png](SpringBoot2/1607004823889-8373cea4-6305-40c1-af3b-921b071a28a8.png)

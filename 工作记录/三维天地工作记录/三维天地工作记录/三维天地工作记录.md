...
| 深圳希诺能源                                                 | liuy                                                  | hz147258                   | [1.Motionpro安装说明 (1).doc](assets\1.Motionpro安装说明 (1).doc)<br />[堡垒机常见问题及解决方案汇总_V2.0_20230428 (1).docx](assets\堡垒机常见问题及解决方案汇总_V2.0_20230428 (1).docx)<br />VPN用户名/密码:姓名拼音/手机号<br />堡垒机用户名/密码：姓名拼音/^YHN7ujm123<br/>mysql  10.7.201.11:3306  用户/密码：root/Sunway_emc |
...
给你个需求，需要编制审核查询三个页面，这三个页面的字段都一样只有按钮功能不一样，审核页只有审核按钮，查询页没有按钮
 ...
 <img src="assets\image-20220706090642993.png" alt="image-20220706090642993" style="zoom:67%;" />



 一个功能模块的结构，resource这一层是接收页面的请求并将请求传给service

 <img src="assets\image-20220706090726058.png" alt="image-20220706090726058" style="zoom:67%;" />
...
<img src="assets\image-20220712131312361.png" alt="image-20220712131312361" style="zoom:67%;" />

...
在实际开发中，通常有多套不同的环境（默认只有public），那么这个时候可以根据指定的环境来创建不 同的 **namespce**，例如，开发、测试和生产三个不同的环境，那么使用一套 nacos 集群可以分别建以下 三个不同的 namespace。以此来实现多环境的隔离![image-20220417152048203](assets/image-20220417152048203.png)
...
![image-20220418121435746](assets/image-20220418121435746.png)![image-20220418121507799](assets/image-20220418121507799.png)
